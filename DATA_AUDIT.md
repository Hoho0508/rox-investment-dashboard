...
| 跨市場正式脈絡                   | TWSE OpenAPI + U.S. Treasury XML Feed  | TAIEX、臺灣50、科技指數、US2Y、US10Y；均標示 delayed。 |
| 美國股票與全球股票指數           | 尚無具明確授權的正式 Provider          | unavailable。                                          |
...
4. 美國股票／全球股票指數、基本面、法人、新聞與族群資金流在取得合法 Provider 前維持 unavailable。
